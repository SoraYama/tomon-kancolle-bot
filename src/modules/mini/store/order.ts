...
class Order {
  ...
  public get toTradeAsText() {
    if (this.orderType === OrderType.RESOURCE_TO_RESOURCE || this.orderType === OrderType.RESOURCE_TO_SHIP) {
  ...
  public get wantedAsText() {
    if (this.orderType === OrderType.RESOURCE_TO_RESOURCE || this.orderType === OrderType.SHIP_TO_RESOURCE) {
